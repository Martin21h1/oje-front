...
const useStyles = makeStyles(theme => ({
    form: {
        ...
        marginTop: theme.spacing(1), marginLeft: theme.spacing(1),
        ...
        margin: theme.spacing(2, 1, 0), width: '90%', [theme.breakpoints.up('sm')]: {
            width: '50%',
        }, [theme.breakpoints.up('md')]: {
            width: '30%',
        },
...
export default function SearchForm() {
    ...
    return (<form className={classes.form} onSubmit={handleSubmit}>
        ...
        {errorsState.message && (<SnackbarComponent severity="error"
